...
**Operaciones** (junto con [[04 - Blanqueria]], Desayuno, Cocina,
Precios e Imprimir).
...
**Nota:** el stock de productos de comida/bebida es el sub-tab "📦 Inventario"
(`renderConsInventario()`, solo admin) DENTRO de Operaciones, hermano de este
sub-tab de Consumición — no es lo mismo que [[04 - Blanqueria]] (bienes de
uso: sábanas, muebles, equipos), que es un sistema de stock totalmente
separado.
